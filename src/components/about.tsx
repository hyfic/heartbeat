  ...
  return (
    <div className='mt-24'>
      ...
      <Text fontSize='xl' mt={5} className='opacity-80'>
        <Link href='https://github.com/hyfic/heartbeat' className='font-medium'>
          HeartBeat
        </Link>{' '}
      ...
      <List spacing={4}>
        ...
        <CustomListItem title='Organize patients using database' />
      ...
      <DarkMode>
        <a
          download
          href='https://github.com/hyfic/heartbeat/releases/download/v1.0.0/heartbeat_1.0.0_x64_installer.msi'
        >
